...
class Ware(models.Model):
    ...
    manufacture = models.CharField(
        max_length=40, choices=MAN_CHOICES, verbose_name=_("Herstellungsart")
    )
    brand = models.CharField(
        max_length=13, choices=BRAND_CHOICES, verbose_name=_("Brand")
    )
    brand_atm = models.CharField(
        max_length=21, choices=BRAND_ATM_CHOICES, verbose_name=_("Brennatmosphäre")
    )
    ...
    magerungsmenge = models.CharField(
        max_length=7, choices=MAGER_MENGE_CHOICES, verbose_name=_("Magerungsmenge")
    )
    magerung_size = models.CharField(
        max_length=10, choices=MAGER_SIZE_CHOICES, verbose_name=_("Magerungsgröße")
    )
    magerung_dist = models.CharField(
        max_length=20, choices=MAGER_DIST_CHOICES, verbose_name=_("Magerungsverteilung")
    )
    magerung_form = models.CharField(
        max_length=9, choices=MAGER_FORM_CHOICES, verbose_name=_("Magerungsform")
    )
